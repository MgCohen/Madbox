...
**Revision note:** Reworked plan: **Scope-first** **`ILayeredScopeProgress`**, **no** static layer-progress helper, **no** installer call sites in Bootstrap; loading view owns UI and optional child view components.
