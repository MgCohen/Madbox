...
### Intentional low-test exception
...
- 2025-03-23: Moved low-test exception under **Testing** as a subsection (`###`) to preserve strict top-level section order.
- Prior: Rewritten to AI-first standard with explicit compatibility boundaries and low-test-module exception policy linkage.
