...
- Reworked to module documentation standard, including full API table, setup/usage/examples/testing, and AI context.
- Initial minimal wallet documentation.
- Added note for module-local gold authoring asset location under `Meta/Gold/Authoring`.
