...
Authoring-time level data: Addressables scene reference, enemy spawn entries (`AssetReferenceT<EnemyData>` from **`Madbox.Enemies`**), and serialized rule assets consumed by `Madbox.Battle`.
