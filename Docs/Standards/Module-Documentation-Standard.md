...
**Document type:** This file **defines** the module documentation standard. It is **not** a module brief: the narrative sections below (`## Why this standard exists`, `## Required section order`, …) describe the rules and include an embedded **template**. Only **module documents** under `Docs/` are expected to follow the `#` … `## Changelog` shape in the template.
...
## Changelog (this standards file)

- 2025-03-23: Added **Document type** note at the top clarifying this file defines the standard and is not itself a module brief.
