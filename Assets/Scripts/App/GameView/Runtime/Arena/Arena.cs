...
namespace Madbox.App.GameView.Arenas
{
    ...
    public sealed class Arena : MonoBehaviour
    {
        ...
        [SerializeField] private CinemachineVirtualCamera battleVirtualCamera;

        /// <summary>Optional; when set, session spawn assigns <see cref="CinemachineVirtualCamera.Follow"/> and <see cref="CinemachineVirtualCamera.LookAt"/> to the spawned player.</summary>
        public CinemachineVirtualCamera BattleVirtualCamera => battleVirtualCamera;

        /// <summary>World-space fallback origin when arena bounds are unavailable; also used with randomized offsets when <see cref="TryGetWorldBounds"/> is false.</summary>
