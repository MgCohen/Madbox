...
namespace Madbox.App.Animation
{
    ...
    /// Assign this asset to the clip animation event Object field; Unity invokes <see cref="AnimationEventRouter.OnCharacterAnimationEvent(Object)"/> (or the typed <see cref="AnimationEventRouter.OnCharacterAnimationEvent(AnimationEventDefinition)"/> overload). Handlers receive <see cref="AnimationEventContext"/>.
    /// </summary>
