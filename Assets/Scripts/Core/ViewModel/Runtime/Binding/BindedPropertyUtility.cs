...
namespace Scaffold.MVVM.Binding
{
    ...
    {
        internal static IBindedProperty<TSource, TTarget> WithConverter<TSource, TTarget>(this IBindedProperty<TSource, TTarget> property, Func<TSource, TTarget> converter)
        {
