...
Use this file as a short guide for writing milestone plan docs referenced by an ExecPlan. The repository is a **complete sample**; milestone files are still the right shape if you add future ExecPlans under `Plans/`.
